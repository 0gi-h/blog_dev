package me.springbootdeveloper.config;

import lombok.RequiredArgsConstructor;
import me.springbootdeveloper.config.jwt.TokenProvider;
import me.springbootdeveloper.config.oauth.OAuth2AuthorizationRequestBasedOnCookieRepository;
import me.springbootdeveloper.config.oauth.OAuth2SuccessHandler;
import me.springbootdeveloper.config.oauth.OAuth2UserCustomService;
...
public class WebOAuthSecurityConfig {
    ...
    @Bean
    public WebSecurityCustomizer config() { //스프링 시큐리티 기능 비활성화
